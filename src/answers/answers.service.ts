...
export class AnswersService {
    ...
    async getAnswersByExamId(examId: number): Promise<{answerId: number, correctAnswer: string}[]> {
        const answers = await this.answersRepository.find({where: {examId: examId}, relations: ['exam']})
